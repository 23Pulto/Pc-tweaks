...
rem Execution policy is not changed at startup. The script uses per-command bypass only where needed.
...
echo.
echo.
echo                                           %red%Made By Pulto%u%
echo.
echo                     %red%I cannot guarantee an FPS increase. Use these optimizations at your own risk.%u%
echo                         %red%This is intended for a clean and stock Windows install.%u%
echo.
echo                                      %white%[1]%u% %red%Agree%u%
echo                                      %white%[2]%u% %red%Disagree And Leave%u%
echo.
echo.
set "userInput="
...
echo %red%Invalid option. Please choose 1 or 2.%u%
timeout /t 2 >nul
goto loading
...
echo.
echo.
echo %u%[%red%-%u%] %red%Leaving without applying tweaks.
echo.
echo %u%Made By: %red%Pulto
echo.
echo.
...
echo.
echo.
echo %u%[%red%+%u%] %red%Agreement accepted. Creating a restore point before continuing.
echo.
echo %u%Made By: %red%Pulto
echo.
echo.
timeout /t 3 >nul /nobreak & cls & goto restorepoint10
...
:GotGPUFixed
echo.
echo %c% ____        _ _        _____                    _        %u%
echo %c%^|  _ \ _   _^| ^| ^|_ ___ ^|_   _^|_      _____  __ _^| ^| _____  %u%
echo %c%^| ^|_) ^| ^| ^| ^| ^| __/ _ \  ^| ^| \ \ /\ / / _ \/ _` ^| ^|/ / __^| %u%
echo %c%^|  __/^| ^|_^| ^| ^| ^|^| (_) ^| ^| ^|  \ V  V /  __/ (_^| ^|   ^<\__ \ %u%
echo %c%^|_^|    \__,_^|_^|\__\___/  ^|_^|   \_/\_/ \___^|\__,_^|_^|\_\___/ %u%
echo.
echo                                      %c%Made By Pulto%u%
echo.
echo                                 %c%Version:%u% %white%%version%%u%     %c%User:%u%%white% %username%%u%     %c%Date:%u%%white% %date%%u%
echo.
echo                   %c%GPU:%u%%white% %GPUName% %u%    %c%CPU:%u%%white% %CPUName%%u%
echo.
echo                                %c%Pulto%u%%white% Tweaks%u%%c% is a batch script that optimizes your system%u%
echo                                      %c%to provide the best gaming experience possible%u%
goto :eof
...
echo %c%                            ╚══════════════════════════════╩═══════════════════════════════╝
echo.
echo                              %u%[%c%13%u%] Main Menu        [%c%14%u%] Back to Main   [%red%X%u%] Exit Application
echo.
echo.
set /p M="%c%Choose an option »%u% "
if %M%==1 goto A
...
echo %c%                                 ╚═══════════════════════════════════════════════════╝
echo.
echo                             %u%[%c%7%u%] Main Menu        [%c%8%u%] Back to Main   [%red%X%u%] Exit Application       
echo.                                      
set /p M="%c%Choose an option »%u% "
...
:Destruct
title Thanks for using Pulto Tweaks!
cls
echo.            
echo %u%Made By: %c%Pulto
timeout /t 5 >nul
endlocal
exit
